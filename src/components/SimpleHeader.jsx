        ...
        <div className="flex flex-col md:flex-row gap-8 md:gap-12 items-center md:items-start">
          ...
          <div className="flex-1 text-center md:text-left w-full">
            ...
            <motion.p
              ...
              className="text-xl sm:text-2xl font-medium italic text-primary dark:text-secondary mb-4"
            >
              &ldquo;Good science responds to real phenomena or real problems.&rdquo; &mdash; Allen Newell
            </motion.p>
            ...
            >
              ...
              <p>
                During his bachelor period, he attended the <a href="https://www.robomaster.com/en-US" target="_blank" rel="noopener noreferrer"><u>RoboMaster Competition</u></a> and thus started his journey as a physical AI missionary. In the master period, he was working on object-level visual SLAM and mobile robots navigation supervised by <a href="https://www.robot.t.u-tokyo.ac.jp/yamalab/index-e.html" target="_blank" rel="noopener noreferrer"><u>Prof. Yamashita Atsushi</u></a>. After graduation, he worked at <a href="https://www.mujin.co.jp/" target="_blank" rel="noopener noreferrer"><u>Mujin Inc.</u></a> as a software developer (computer vision) and created numerous robotic products for real-world factories and warehouses.
              </p>
            </motion.div>
